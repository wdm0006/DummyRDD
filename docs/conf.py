...
htmlhelp_basename = 'dummyparkdoc'
...
latex_documents = [
  ('index', 'dummyspark.tex', u'dummyspark Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    ('index', 'dummyspark', u'dummyspark Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
  ('index', 'dummyspark', u'dummyspark Documentation',
   u'Author', 'dummyspark', 'One line description of project.',
   'Miscellaneous'),
]
